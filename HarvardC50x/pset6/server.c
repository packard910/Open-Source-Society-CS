...
const char* lookup(const char* extension)
{
    ...
    const int numExtensions = 7;

    // define static array for file extensions
    static char* extensionArray[numExtensions] = {
        "css",
        "html",
        "gif",
        "ico",
    ...
    // define static array for return values
    static char* fileTypeArray[numExtensions] = {
        "text/css",
        "text/html",
        "image/gif",
        "image/x-icon",
    ...
    {
        if(strcmp(extension,extensionArray[i])==0)
        {
